...
public class App {
    public static void main(String[] args) {
        ...
        RecordPatterns.ColoredPoint pointColor =
                new RecordPatterns.ColoredPoint(point, RecordPatterns.Color.RED);
        ...
        RecordPatterns.printXCoordOfUpperLeftPointWithPatterns(new RecordPatterns.Rectangle(pointColor, pointColor));
